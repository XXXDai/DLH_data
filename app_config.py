...
S3_MAX_POOL_CONNECTIONS = 64  # S3连接池大小，个
S3_UPLOAD_MAX_CONCURRENCY = 32  # S3单文件并发上传数，个
S3_MULTIPART_THRESHOLD_BYTES = 8 * 1024 * 1024  # S3分片上传阈值，字节
S3_MULTIPART_CHUNKSIZE_BYTES = 16 * 1024 * 1024  # S3分片大小，字节
S3_USE_THREADS = True  # S3并发传输开关，开关
