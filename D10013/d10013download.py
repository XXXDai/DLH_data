...
def main() -> None:
    ...
    while True:
        threads = [
            threading.Thread(
                target=run_exchange,
                args=("bybit", resolve_bybit_symbols(), get_latest_local_date, sync_bybit_month),
                daemon=True,
            ),
            threading.Thread(
                target=run_exchange,
                args=("binance", cex_config.get_future_trade_symbols("binance"), get_latest_local_date, sync_binance_month),
                daemon=True,
            ),
            threading.Thread(
                target=run_exchange,
                args=("bitget", cex_config.get_future_trade_symbols("bitget"), get_latest_bitget_local_date, sync_bitget_month),
                daemon=True,
            ),
            threading.Thread(
                target=run_exchange,
                args=("okx", resolve_okx_symbols(), get_latest_local_date, sync_okx_month),
                daemon=True,
            ),
        ]
